...
At the end of the general overview, a ℹ️ **Note** suggests to the user to run `extract_diff_rows()` to see the differences in the number of rows. More on this function in the article [Extract Different Rows](extract-diff-rows.html).
