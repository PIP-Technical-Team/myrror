...
# myrror
<!-- badges: start -->
`r badger::badge_cran_checks("myrror")``r badger::badge_cran_release("myrror", "orange")` `r badger::badge_devel("giorgiacek/myrror", "blue")` `r badger::badge_codecov("giorgiacek/myrror")` `r badger::badge_lifecycle("experimental", "orange")`
